...
func inputcheck1() () {
	...
	t=Ticket{t.Min, t.Max, t.Value}

	if t.Min<100000 ||t.Min>999999 ||t.Max<100000 || t.Max>999999 {
		fmt.Println("Sorry. You entered incorrect digit lenght. Please try again")
	}
	happy := t.Simple()
	fmt.Print(happy)
	happy = t.Difficult()
